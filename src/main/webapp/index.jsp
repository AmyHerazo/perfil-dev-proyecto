<%@ page contentType="text/html;charset=UTF-8" language="java" %>
    ...
    <body>
            ...
            <main class="landing-main">
                <div class="card card-featured">
                    ...
                    <div class="card-content">
                        ...
                        <p>Así es como los reclutadores y colegas verán tu portafolio profesional. Incluye tus
                            proyectos, habilidades y experiencia.</p>
            ...
            <footer class="landing-footer">
                <div class="footer-content">
                    ...
                    <div class="footer-section">
                        ...
                        <% if (session.getAttribute("usuario") !=null) { %>
                            <p>Sesión activa: <span class="session-status">
                            ...
                            <% } else { %>
                                <a href="login.jsp" class="btn btn-sm btn-secondary">
                                    <i class="fas fa-sign-in-alt"></i> Iniciar Sesión Admin
                                </a>
                                <% } %>
                    </div>
                </div>
                <div class="footer-bottom">
                    <p>&copy; 2025 Mi Perfil Dev. Todos los derechos reservados. |
                        <i class="fas fa-heart"></i> Hecho con pasión por desarrolladores
                    </p>
                </div>
            </footer>
        </div>
        ...
        <script>
            ...
            // Load Banner Data
            fetch('${pageContext.request.contextPath}/perfil')
                .then(response => {
                ...
                .then(data => {
                    if (data) {
                        if (data.tituloBanner) {
                            const titleEl = document.getElementById('banner-title');
                            if (data.tituloBanner.includes("Dev")) {
                                titleEl.innerHTML = data.tituloBanner.replace("Dev", "<span class='highlight'>Dev</span>");
                            } else {
                                titleEl.textContent = data.tituloBanner;
                            }
                        }
                        if (data.subtituloBanner) {
                            document.getElementById('banner-subtitle').textContent = data.subtituloBanner;
                        }
                    }
                })
                .catch(error => console.log('No profile data yet or error loading banner'));
        </script>
    </body>
